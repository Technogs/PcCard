...
export default class CreatePost extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedHockeyTypeId: '',
      selectedHockeyType: 0,
      selectedMagicTeamId: '',
      selectedMagicTeam: 0,
      selectedMagicTypeId: '',
      selectedMagicType: 0,
    ...
    if (err === 0) {
      ...
      switch (this.state.selectedCardGameId) {
        ...
        case 3:
          ...
          cardType =
            this.state.selectedHockeyType === 0
              ? ''
              : this.state.hockeyCardType[
                  parseInt(this.state.selectedHockeyType)
                ];
          break;
        case 4:
          nameTeam =
      ...
      let postData = {
        ...
        conditionData:
          this.state.selectedConditionId === 0
            ? ''
            : this.state.conditionData[
                parseInt(this.state.selectedConditionId)
              ],
        cardType,
        rarity:
          ...
          <ScrollView nestedScrollEnabled={true}>
            ...
            {this.state.selectedCardGameId === 1 ? (
              <>
                ...
                <View style={styles.row}>
                  ...
                  <Picker
                    ...
                    onValueChange={(itemValue, itemIndex) => {
                      if (
                        this.state.baseballCardType[itemIndex].cardType ===
                        'Other'
                      ) {
              ...
              <>
                ...
                <View style={styles.row}>
                  ...
                  <Picker
                    ...
                    onValueChange={(itemValue, itemIndex) => {
                      if (
                        this.state.basketballCardType[itemIndex].cardType ===
                        'Other'
                      ) {
                        this.setState({showOther: true});
                      } else {
              ...
              <>
                ...
                <View style={styles.row}>
                  ...
                  <Picker
                    style={styles.pickerStyle}
                    selectedValue={this.state.selectedHockeyType}
                    mode="dropdown"
                    onFocus={() => Keyboard.dismiss()}
                    onValueChange={(itemValue, itemIndex) => {
                      if (
                        this.state.hockeyCardType[itemIndex].cardType ===
                        'Others'
                      ) {
                        this.setState({showOther: true});
                      } else {
                      ...
                      this.setState({
                        selectedHockeyTypeId: itemValue,
                        selectedHockeyType: itemIndex,
                      });
                    }}>
                    {this.state.hockeyCardType.map(item => (
                      <Picker.Item
                        key={item.id}
                        label={
                          this.state.selectedLang === 'en'
              ...
              <>
                ...
                <View style={styles.row}>
                  ...
                  <Picker
                    ...
                    onValueChange={(itemValue, itemIndex) => {
                      if (
                        this.state.soccerCardType[itemIndex].cardType ===
                        'Other'
                      ) {
                        this.setState({showOther: true});
                      } else {
            ...
            {this.state.selectedCardGameId === 0 ? null : (
              <View style={styles.row}>
                ...
                <Picker
                  style={styles.pickerStyle}
                  selectedValue={this.state.selectedConditionId}
                  mode="dropdown"
                  onFocus={() => Keyboard.dismiss()}
                  onValueChange={(itemValue, itemIndex) =>
                    this.setState({
                      selectedConditionId: itemValue,
                    })
                  }>
